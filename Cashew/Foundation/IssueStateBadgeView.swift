...
class IssueStateBadgeView: BaseView {
    ...
    fileprivate func didSetOpen() {
        ...
        if open {
            text = NSAttributedString(string: "Open", attributes: [.foregroundColor: textColor, .paragraphStyle: paragraphStyle, .font: font])
            ...
            text = NSAttributedString(string: "Closed", attributes: [.foregroundColor: textColor, .paragraphStyle: paragraphStyle, .font: font])
